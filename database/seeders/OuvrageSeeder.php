...
class OuvrageSeeder extends Seeder
{
    public function run()
    {
        Ouvrage::insert([
            ...
            ['cote'=>6,'auteur'=>'Gustave Flaubert','titre'=>'Madame Bovary','anneeParution'=>1857,'type'=>'roman','urlImage'=>'images/couvertures/livre.png','created_at'=>now(),'updated_at'=>now()],
            ...
            ['cote'=>15,'auteur'=>'Jules Romains','titre'=>'Les Hommes de bonne volonté','anneeParution'=>1930,'type'=>'roman','urlImage'=>'images/couvertures/livre.png','created_at'=>now(),'updated_at'=>now()],
            ...
            ['cote'=>23,'auteur'=>'Patrick Chamoiseau','titre'=>'Texaco','anneeParution'=>1992,'type'=>'roman','urlImage'=>'images/couvertures/texaco.jpg','created_at'=>now(),'updated_at'=>now()],
            ...
            ['cote'=>42,'auteur'=>'Daniel Maximin','titre'=>'L\'île et une nuit','anneeParution'=>2002,'type'=>'roman','urlImage'=>'images/couvertures/l_ile_et_une_nuit.jpg','created_at'=>now(),'updated_at'=>now()],
            ...
            ['cote'=>48,'auteur'=>'Gisèle Pineau','titre'=>'Folie, aller simple : Journée ordinaires d\'une infirmière','anneeParution'=>2010,'type'=>'roman','urlImage'=>'images/couvertures/livre.png','created_at'=>now(),'updated_at'=>now()],
            ...
            ['cote'=>50,'auteur'=>'Joseph Zobel','titre'=>'Et si la mer n\'était pas bleue','anneeParution'=>1982,'type'=>'nouvelle','urlImage'=>'images/couvertures/et_si_la_mer_n_etait_pas_bleue.jpg','created_at'=>now(),'updated_at'=>now()],
            ...
            ['cote'=>55,'auteur'=>'Saint-John Perse','titre'=>'Éloges','anneeParution'=>1911,'type'=>'poesie','urlImage'=>'images/couvertures/eloges.jpg','created_at'=>now(),'updated_at'=>now()],
